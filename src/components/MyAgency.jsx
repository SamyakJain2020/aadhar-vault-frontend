          ...
          <div class="bg-blue-500 dark:bg-white-800 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-blue-600 dark:border-white-600 text-white font-medium group">
            <div class="flex justify-center items-center w-14 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:rotate-12">
              <svg
                ...
                viewBox="0 0 24 24"
                stroke="currentColor"
                class="stroke-current text-blue-800 dark:text-white-800 transform transition-transform duration-500 ease-in-out"
              >
                <path
            ...
            <div class="rounded-t mb-0 px-0 border-0">
              ...
              <div class="block w-full overflow-x-auto">
                <table class="items-center w-full bg-transparent border-collapse">
                  <thead>
                    <tr>
                      <th class="px-4 bg-white-100 dark:bg-white-600 text-white-500 dark:text-white-100 align-middle border border-solid border-white-200 dark:border-white-500 py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left">
                        Referral
                      </th>
                      <th class="px-4 bg-white-100 dark:bg-white-600 text-white-500 dark:text-white-100 align-middle border border-solid border-white-200 dark:border-white-500 py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left">
                        Visitors
                      </th>
                      <th class="px-4 bg-white-100 dark:bg-white-600 text-white-500 dark:text-white-100 align-middle border border-solid border-white-200 dark:border-white-500 py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left min-w-140-px"></th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr class="text-white-700 dark:text-white-100">
              ...
              <table class="w-full">
                ...
                <tbody class="bg-white divide-y dark:divide-white-700 dark:bg-white-800">
                    ...
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        ...
                        <div>
                          ...
                          <p class="text-xs text-white-600 dark:text-white-400">
                            10x Developer
                          </p>
                        </div>
                      </div>
                  ...
                  <tr class="bg-white-50 dark:bg-white-800 hover:bg-white-100 dark:hover:bg-white-900 text-white-700 dark:text-white-400">
                    ...
                    <td class="px-4 py-3 text-xs">
                      <span class="px-2 py-1 font-semibold leading-tight text-white-700 bg-white-100 rounded-full dark:text-white-100 dark:bg-white-700">
                        {" "}
                        Expired{" "}
                      </span>
                    </td>
